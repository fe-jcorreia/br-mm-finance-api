...
import { AuthenticatedContext, ContextProvider, ServerContext } from "@/core/context";
import { UnauthorizedError } from "@/core/error/generic";

export function AuthorizationMiddleware(_req: Request, _res: Response, next: NextFunction) {
